...
const PARTIDOS_GRUPOS = [
  ...
  { id:"gA2", grupo:"A", eq1:"Corea del Sur", eq2:"Rep. Checa",   fecha:"12 Jun", hora:"18:00" },
  { id:"gA3", grupo:"A", eq1:"México",        eq2:"Corea del Sur",fecha:"16 Jun", hora:"21:00" },
  { id:"gA4", grupo:"A", eq1:"Rep. Checa",    eq2:"Sudáfrica",    fecha:"16 Jun", hora:"18:00" },
  { id:"gA5", grupo:"A", eq1:"México",        eq2:"Rep. Checa",   fecha:"20 Jun", hora:"21:00" },
  { id:"gA6", grupo:"A", eq1:"Sudáfrica",     eq2:"Corea del Sur",fecha:"20 Jun", hora:"21:00" },
  { id:"gB1", grupo:"B", eq1:"Canadá",        eq2:"Haití",        fecha:"12 Jun", hora:"00:00" },
  { id:"gB2", grupo:"B", eq1:"Marruecos",     eq2:"Bélgica",      fecha:"12 Jun", hora:"21:00" },
  { id:"gB3", grupo:"B", eq1:"Canadá",        eq2:"Marruecos",    fecha:"16 Jun", hora:"00:00" },
  { id:"gB4", grupo:"B", eq1:"Bélgica",       eq2:"Haití",        fecha:"16 Jun", hora:"21:00" },
  { id:"gB5", grupo:"B", eq1:"Canadá",        eq2:"Bélgica",      fecha:"20 Jun", hora:"00:00" },
  { id:"gB6", grupo:"B", eq1:"Haití",         eq2:"Marruecos",    fecha:"20 Jun", hora:"00:00" },
  { id:"gC1", grupo:"C", eq1:"Brasil",        eq2:"Argelia",      fecha:"13 Jun", hora:"00:00" },
  { id:"gC2", grupo:"C", eq1:"Paraguay",      eq2:"Japón",        fecha:"13 Jun", hora:"03:00" },
  { id:"gC3", grupo:"C", eq1:"Brasil",        eq2:"Paraguay",     fecha:"17 Jun", hora:"21:00" },
  { id:"gC4", grupo:"C", eq1:"Japón",         eq2:"Argelia",      fecha:"17 Jun", hora:"18:00" },
  { id:"gC5", grupo:"C", eq1:"Brasil",        eq2:"Japón",        fecha:"21 Jun", hora:"21:00" },
  { id:"gC6", grupo:"C", eq1:"Argelia",       eq2:"Paraguay",     fecha:"21 Jun", hora:"21:00" },
  { id:"gD1", grupo:"D", eq1:"Estados Unidos",eq2:"Panamá",       fecha:"13 Jun", hora:"21:00" },
  { id:"gD2", grupo:"D", eq1:"Uruguay",       eq2:"Irak",         fecha:"13 Jun", hora:"18:00" },
  { id:"gD3", grupo:"D", eq1:"Estados Unidos",eq2:"Uruguay",      fecha:"17 Jun", hora:"21:00" },
  { id:"gD4", grupo:"D", eq1:"Irak",          eq2:"Panamá",       fecha:"17 Jun", hora:"18:00" },
  { id:"gD5", grupo:"D", eq1:"Estados Unidos",eq2:"Irak",         fecha:"21 Jun", hora:"21:00" },
  { id:"gD6", grupo:"D", eq1:"Panamá",        eq2:"Uruguay",      fecha:"21 Jun", hora:"21:00" },
  { id:"gE1", grupo:"E", eq1:"Alemania",      eq2:"Curazao",      fecha:"14 Jun", hora:"18:00" },
  { id:"gE2", grupo:"E", eq1:"Costa de Marfil",eq2:"Colombia",    fecha:"14 Jun", hora:"21:00" },
  { id:"gE3", grupo:"E", eq1:"Alemania",      eq2:"Costa de Marfil",fecha:"18 Jun",hora:"21:00"},
  { id:"gE4", grupo:"E", eq1:"Colombia",      eq2:"Curazao",      fecha:"18 Jun", hora:"18:00" },
  { id:"gE5", grupo:"E", eq1:"Alemania",      eq2:"Colombia",     fecha:"22 Jun", hora:"21:00" },
  { id:"gE6", grupo:"E", eq1:"Curazao",       eq2:"Costa de Marfil",fecha:"22 Jun",hora:"21:00"},
  { id:"gF1", grupo:"F", eq1:"Países Bajos",  eq2:"Bosnia y Herz.",fecha:"14 Jun",hora:"00:00" },
  { id:"gF2", grupo:"F", eq1:"Ecuador",       eq2:"Senegal",      fecha:"14 Jun", hora:"03:00" },
  { id:"gF3", grupo:"F", eq1:"Países Bajos",  eq2:"Ecuador",      fecha:"18 Jun", hora:"00:00" },
  { id:"gF4", grupo:"F", eq1:"Senegal",       eq2:"Bosnia y Herz.",fecha:"18 Jun",hora:"03:00" },
  { id:"gF5", grupo:"F", eq1:"Países Bajos",  eq2:"Senegal",      fecha:"22 Jun", hora:"21:00" },
  { id:"gF6", grupo:"F", eq1:"Bosnia y Herz.",eq2:"Ecuador",      fecha:"22 Jun", hora:"21:00" },
  { id:"gG1", grupo:"G", eq1:"Bélgica",       eq2:"Arabia Saudita",fecha:"15 Jun",hora:"18:00" },
  { id:"gG2", grupo:"G", eq1:"Australia",     eq2:"Ghana",        fecha:"15 Jun", hora:"21:00" },
  { id:"gG3", grupo:"G", eq1:"Bélgica",       eq2:"Australia",    fecha:"19 Jun", hora:"21:00" },
  { id:"gG4", grupo:"G", eq1:"Ghana",         eq2:"Arabia Saudita",fecha:"19 Jun",hora:"18:00" },
  { id:"gG5", grupo:"G", eq1:"Bélgica",       eq2:"Ghana",        fecha:"23 Jun", hora:"21:00" },
  { id:"gG6", grupo:"G", eq1:"Arabia Saudita",eq2:"Australia",    fecha:"23 Jun", hora:"21:00" },
  { id:"gH1", grupo:"H", eq1:"España",        eq2:"Uzbekistán",   fecha:"15 Jun", hora:"00:00" },
  { id:"gH2", grupo:"H", eq1:"Egipto",        eq2:"Noruega",      fecha:"15 Jun", hora:"03:00" },
  { id:"gH3", grupo:"H", eq1:"España",        eq2:"Egipto",       fecha:"19 Jun", hora:"00:00" },
  { id:"gH4", grupo:"H", eq1:"Noruega",       eq2:"Uzbekistán",   fecha:"19 Jun", hora:"03:00" },
  { id:"gH5", grupo:"H", eq1:"España",        eq2:"Noruega",      fecha:"23 Jun", hora:"21:00" },
  { id:"gH6", grupo:"H", eq1:"Uzbekistán",    eq2:"Egipto",       fecha:"23 Jun", hora:"21:00" },
  { id:"gI1", grupo:"I", eq1:"Francia",       eq2:"Catar",        fecha:"16 Jun", hora:"03:00" },
  { id:"gI2", grupo:"I", eq1:"Austria",       eq2:"Escocia",      fecha:"16 Jun", hora:"00:00" },
  { id:"gI3", grupo:"I", eq1:"Francia",       eq2:"Austria",      fecha:"20 Jun", hora:"03:00" },
  { id:"gI4", grupo:"I", eq1:"Escocia",       eq2:"Catar",        fecha:"20 Jun", hora:"00:00" },
  { id:"gI5", grupo:"I", eq1:"Francia",       eq2:"Escocia",      fecha:"24 Jun", hora:"21:00" },
  { id:"gI6", grupo:"I", eq1:"Catar",         eq2:"Austria",      fecha:"24 Jun", hora:"21:00" },
  { id:"gJ1", grupo:"J", eq1:"Argentina",     eq2:"Argelia",      fecha:"16 Jun", hora:"21:00" },
  { id:"gJ2", grupo:"J", eq1:"Austria",       eq2:"Jordania",     fecha:"16 Jun", hora:"18:00" },
  { id:"gJ3", grupo:"J", eq1:"Argentina",     eq2:"Austria",      fecha:"20 Jun", hora:"18:00" },
  { id:"gJ4", grupo:"J", eq1:"Jordania",      eq2:"Argelia",      fecha:"20 Jun", hora:"21:00" },
  { id:"gJ5", grupo:"J", eq1:"Argentina",     eq2:"Jordania",     fecha:"24 Jun", hora:"21:00" },
  { id:"gJ6", grupo:"J", eq1:"Argelia",       eq2:"Austria",      fecha:"24 Jun", hora:"21:00" },
  { id:"gK1", grupo:"K", eq1:"Portugal",      eq2:"Cabo Verde",   fecha:"17 Jun", hora:"03:00" },
  { id:"gK2", grupo:"K", eq1:"Croacia",       eq2:"Túnez",        fecha:"17 Jun", hora:"00:00" },
  { id:"gK3", grupo:"K", eq1:"Portugal",      eq2:"Croacia",      fecha:"21 Jun", hora:"03:00" },
  { id:"gK4", grupo:"K", eq1:"Túnez",         eq2:"Cabo Verde",   fecha:"21 Jun", hora:"00:00" },
  { id:"gK5", grupo:"K", eq1:"Portugal",      eq2:"Túnez",        fecha:"25 Jun", hora:"21:00" },
  { id:"gK6", grupo:"K", eq1:"Cabo Verde",    eq2:"Croacia",      fecha:"25 Jun", hora:"21:00" },
  { id:"gL1", grupo:"L", eq1:"Inglaterra",    eq2:"Irán",         fecha:"17 Jun", hora:"21:00" },
  { id:"gL2", grupo:"L", eq1:"Suecia",        eq2:"RD del Congo", fecha:"17 Jun", hora:"18:00" },
  { id:"gL3", grupo:"L", eq1:"Inglaterra",    eq2:"Suecia",       fecha:"21 Jun", hora:"18:00" },
  { id:"gL4", grupo:"L", eq1:"RD del Congo",  eq2:"Irán",         fecha:"21 Jun", hora:"21:00" },
  { id:"gL5", grupo:"L", eq1:"Inglaterra",    eq2:"RD del Congo", fecha:"25 Jun", hora:"21:00" },
  { id:"gL6", grupo:"L", eq1:"Irán",          eq2:"Suecia",       fecha:"25 Jun", hora:"21:00" },
];
